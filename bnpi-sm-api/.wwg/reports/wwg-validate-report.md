...
critical: 0, high: 0, medium: 0, low: 11, info: 13

## Command

`wwg ci validate: validate`
...
- WARN Skill Registry and Skill Manifest validate when present - 13 finding(s)
...
- INFO markdown-contract-quality-report-generated (reports/context-skill-quality.md): Markdown contract quality report completed with 125 warning(s) and 107 suggestion(s).
