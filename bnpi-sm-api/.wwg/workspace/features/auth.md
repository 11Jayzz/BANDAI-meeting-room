# Feature Checklist: Authentication

**How to use**

1. Prefer auto-scaffold: `npm run feature:new -- auth title:Name owner:<agent> module`  
...
# B — Scaffold
npm run feature:new -- auth title:FeatureName owner:<agent> module
