# Feature Checklist: Rooms

**How to use**

1. Prefer auto-scaffold: `npm run feature:new -- rooms title:Name owner:<agent> module`  
...
# B — Scaffold
npm run feature:new -- rooms title:FeatureName owner:<agent> module
