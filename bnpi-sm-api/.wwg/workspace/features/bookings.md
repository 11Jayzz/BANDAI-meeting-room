# Feature Checklist: Bookings

**How to use**

1. Prefer auto-scaffold: `npm run feature:new -- bookings title:Name owner:<agent> module`  
...
# B — Scaffold
npm run feature:new -- bookings title:FeatureName owner:<agent> module
