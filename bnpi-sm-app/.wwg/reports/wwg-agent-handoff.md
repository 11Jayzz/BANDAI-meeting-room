...
- [ ] Infrastructure readiness not checked (available)
  ...
  - Evidence: `package.json scripts`, `.env`, `.env.example`
...
C:\Users\CK\Documents\BDSM\bnpi-sm-app
...
- Recommended domain skills: 9
- Recommended reference-only skills: business.business-brief, business.sop-writing, public.public-discovery-maintenance, public.public-surface-update, software.bug-fix, software.feature-implementation, software.runtime-infrastructure, software.web.component-architecture, software.web.react-patterns
- Creative/Business recommendations: business.business-brief, business.sop-writing (reference-only; no skill files copied)
- Local project skills: 0
- Disabled skills: 0
- Skill materialization: none 0, reference 10, copied 5, local 0
- Skill policy: manifest present, no policy violations
- Detected domains: business.compliance, business.operations, business.strategy, software.security, software.testing, software.web
...
Developers implementing features on the template, AI coding agents (generic, grok, claude-code, codex, cursor, kimi, etc.), End users of the SPA once domain features ship

## MVP Features

Runnable SPA shell with home page, Atomic component vertical slice, Config + i18n foundations, Unit + E2E home/shell coverage, WWG adoption + multi-agent operating contract, feature:new checklist automation
...
- Home (/)
Expected count: 1
- Public: Home (/) — entire SPA shell is public until auth is intentionally added
- Login required: None in template scope — no login required for any current route
- Admin only: None in template scope — no admin-only routes until product admin is designed
...
Clean enterprise-ready admin/dashboard-friendly UI with design tokens
...
- Open VSCode.
- File -> Open Folder.
- Select: C:\Users\CK\Documents\BDSM\bnpi-sm-app.
