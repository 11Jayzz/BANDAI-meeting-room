...
critical: 0, high: 0, medium: 0, low: 15, info: 13

## Command

`wwg validate --target C:\Users\CK\Documents\BDSM\bnpi-sm-app --format plain`
...
- WARN Skill Registry and Skill Manifest validate when present - 17 finding(s)
...
- INFO markdown-contract-quality-report-generated (reports/context-skill-quality.md): Markdown contract quality report completed with 117 warning(s) and 136 suggestion(s).
