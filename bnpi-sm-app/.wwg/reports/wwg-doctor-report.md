...
Generated at: 2026-07-20T06:09:55.709Z
...
- Review-only or candidate/optional findings remaining: 44
...
- LOW readme-bloat-detected (README.md): README.md may contain detailed material that belongs in focused docs.
...
- HIGH wwg-report-truth-sync-fields-missing (reports/wwg-intake-dry-run-report.md): Report claims readiness or completion without required WWG truth synchronization fields.
- MEDIUM readme-bloat (README.md): README appears to contain detailed governance doctrine.
...
- INFO candidate-principle-like-content (workspace/feature-checklist.template.md): Potential principle-like content was found outside the principles folder.
...
- warn: validate - Validated C:\Users\Renz\Documents\bnpi-sm\bnpi-sm-app.
...
- .wwg/reports/backups/wwg.project.20260720T060956Z.yaml
...
- low: readme-bloat-detected - README.md may contain detailed material that belongs in focused docs. (README.md) Recommendation: Run `wwg readme route-docs --target . --dry-run`.
...
- info: candidate-principle-like-content - Potential principle-like content was found outside the principles folder. (workspace/feature-checklist.template.md) Recommendation: Review whether this durable guidance should become a candidate Principle Brief; do not treat this as a critical error.
...
- info: public-surface-artifact - Public surface or discovery artifact detected. (e2e/support/copy.ts) Recommendation: Treat public/trust messaging changes as approval-gated when content is customer-facing.
- info: public-surface-artifact - Public surface or discovery artifact detected. (e2e/support/index.ts) Recommendation: Treat public/trust messaging changes as approval-gated when content is customer-facing.
- info: public-surface-artifact - Public surface or discovery artifact detected. (e2e/support/routes.ts) Recommendation: Treat public/trust messaging changes as approval-gated when content is customer-facing.
- info: public-surface-artifact - Public surface or discovery artifact detected. (e2e/support/test-ids.ts) Recommendation: Treat public/trust messaging changes as approval-gated when content is customer-facing.
- info: public-surface-detected - Detected 6 public surface/public discovery artifact(s). Recommendation: Map existing public discovery sources before proposing new ones.
- info: readme-detected - README.md was detected at 208 lines. (README.md) Recommendation: Validate it with `wwg readme validate --target .`.
...
- info: todo-fixme-tbd-detected - TODO/FIXME/TBD marker detected. (governance/drift-guard.md) Recommendation: Confirm whether this is intentional tracked work or convert it into a report/follow-up.
...
- info: todo-fixme-tbd-detected - TODO/FIXME/TBD marker detected. (governance/truth-capture.md) Recommendation: Confirm whether this is intentional tracked work or convert it into a report/follow-up.
...
- high: wwg-report-truth-sync-fields-missing - Report claims readiness or completion without required WWG truth synchronization fields. (reports/wwg-intake-dry-run-report.md) Recommendation: Add WWG Truth Synchronization, task mode, truth/update/governance/drift fields, and remaining stale context before claiming completion.
- info: wwg-principles-valid - Principles folder and lightweight Principle Brief checks passed.
- info: generated-markers-balanced - Generated marker pairs are balanced where present.
- info: markdown-readable - Markdown files are non-empty and readable.
- info: ambiguous-report-classification - Some report-like files need human classification. Recommendation: Run `wwg reports --target .` and review the Ambiguous / Needs Review section.
- info: markdown-contract-quality-report-generated - Markdown contract quality report completed with 91 warning(s) and 56 suggestion(s). (reports/context-skill-quality.md) Recommendation: Review `.wwg/reports/context-skill-quality.md` during focused documentation remediation.
- medium: readme-bloat - README appears to contain detailed governance doctrine. (README.md) Recommendation: Run `wwg readme route-docs --target . --dry-run` and keep README as a front door.
...
- low: readme-status-stale - Package version 0.1.0 is not mentioned in README status. (README.md) Recommendation: Review Current Status and version wording.
