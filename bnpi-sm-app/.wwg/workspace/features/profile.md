# Feature Checklist: Profile

**How to use**

1. Prefer: `npm run feature:new -- profile title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/profile/`
- [ ] Spec(s): `e2e/features/profile/profile.spec.ts`
- [ ] Page Object: `e2e/pages/profile.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/profile`
...
npm run test
npm run test:e2e -- e2e/features/profile
npm run test:e2e:open -- e2e/features/profile   # watch browser
npm run typecheck
npm run lint
