# Feature Checklist: Dashboard

**How to use**

1. Prefer: `npm run feature:new -- dashboard title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/dashboard/`
- [ ] Spec(s): `e2e/features/dashboard/dashboard.spec.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/dashboard`
...
npm run test:e2e:open -- e2e/features/dashboard   # watch browser
npm run typecheck
npm run lint
