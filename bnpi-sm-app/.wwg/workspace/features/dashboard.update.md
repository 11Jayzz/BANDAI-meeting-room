# Feature Update: Dashboard (dashboard)

**Auto-generated** by `npm run feature:update -- dashboard` on 2026-07-24.

Update id: `20260724-1020`
...
| Page path exists? | YES — `src/pages/dashboard/` |
| E2E path exists? | YES — `e2e/features/dashboard/` |
| Parent checklist | [`dashboard.md`](./dashboard.md) |
...
```text
Summary:
Card/chart dashboard redesign: upcoming meetings, bookings donut, room utilization trend, quick actions
...
```bash
npm run feature:update -- dashboard summary:"…" owner:<agent>
npm run test
npm run test:e2e -- e2e/features/dashboard
npm run check
npm run wwg:brief
```
