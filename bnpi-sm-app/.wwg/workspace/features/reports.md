# Feature Checklist: Reports

**How to use**

1. Prefer: `npm run feature:new -- reports title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/reports/`
- [ ] Spec(s): `e2e/features/reports/reports.spec.ts`
- [ ] Page Object: `e2e/pages/reports.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/reports`
...
npm run test
npm run test:e2e -- e2e/features/reports
npm run test:e2e:open -- e2e/features/reports   # watch browser
npm run typecheck
npm run lint
