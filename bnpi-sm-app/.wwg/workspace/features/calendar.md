...
1. Prefer: `npm run feature:new -- calendar title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/calendar/`
- [ ] Spec(s): `e2e/features/calendar/calendar.spec.ts`
- [ ] Page Object: `e2e/pages/calendar.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/calendar`
...
npm run test
npm run test:e2e -- e2e/features/calendar
npm run test:e2e:open -- e2e/features/calendar   # watch browser
npm run typecheck
npm run lint
