# Feature Checklist: Public Calendar

**How to use**

1. Prefer: `npm run feature:new -- public-calendar title:Name owner:<agent> e2e page`
...
| Field | Value |
| --- | --- |
| Feature name | Public Calendar |
| Feature slug | `public-calendar` |
...
- [ ] Feature folder: `e2e/features/public-calendar/`
- [ ] Spec(s): `e2e/features/public-calendar/public-calendar.spec.ts`
- [ ] Page Object: `e2e/pages/public-calendar.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/public-calendar`
...
npm run test
npm run test:e2e -- e2e/features/public-calendar
npm run test:e2e:open -- e2e/features/public-calendar   # watch browser
npm run typecheck
npm run lint
