# Feature Checklist: Room Management

**How to use**

1. Prefer: `npm run feature:new -- room-management title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/room-management/`
- [ ] Spec(s): `e2e/features/room-management/room-management.spec.ts`
- [ ] Page Object: `e2e/pages/room-management.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/room-management`
...
npm run test
npm run test:e2e -- e2e/features/room-management
npm run test:e2e:open -- e2e/features/room-management   # watch browser
npm run typecheck
npm run lint
