# Feature Checklist: Login

**How to use**

1. Prefer: `npm run feature:new -- login title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/login/`
- [ ] Spec(s): `e2e/features/login/login.spec.ts`
- [ ] Page Object: `e2e/pages/login.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/login`
...
npm run test
npm run test:e2e -- e2e/features/login
npm run test:e2e:open -- e2e/features/login   # watch browser
npm run typecheck
npm run lint
