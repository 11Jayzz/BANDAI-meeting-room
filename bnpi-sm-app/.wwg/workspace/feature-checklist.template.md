...
1. Prefer: `npm run feature:new -- <feature-slug> title:Name owner:<agent> e2e page`
...
- [ ] Feature folder: `e2e/features/<feature-slug>/`
- [ ] Spec(s): `e2e/features/<feature-slug>/<feature-slug>.spec.ts`
- [ ] Page Object: `e2e/pages/<feature-slug>.page.ts`
...
- [ ] Optional visual watch: `npm run test:e2e:open -- e2e/features/<feature-slug>`
...
npm run test:e2e:open -- e2e/features/<feature-slug>   # watch browser
npm run typecheck
npm run lint
